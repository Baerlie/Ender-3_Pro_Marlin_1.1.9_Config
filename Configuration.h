...
#define STRING_CONFIG_H_AUTHOR "(Beatrice Pscheidl, Ender-3 Pro)" // Who made the changes.
#define SHOW_BOOTSCREEN   // custom setup BP
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro (1.1.9.1)"
 ...
 */
// custom setup BP (default Ender-3 Pro)
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 4)   // custom setup BP

// The number of probes to perform at each point.
//   Set to 2 for a fast/slow probe, using the second probe result.
//   Set to 3 or more for slow probes, averaging the results.
#define MULTIPLE_PROBING 2    // custom setup BP
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Z    // custom setup BP
#endif
...
#define AUTO_BED_LEVELING_BILINEAR    // customized BP
 ...
 */
#define RESTORE_LEVELING_AFTER_G28    // customized BP
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5   // custom setup BP (5x5 mesh)
 ...
 */
#define LCD_BED_LEVELING  // custom setup BP

#if ENABLED(LCD_BED_LEVELING)
  #define MBL_Z_STEP 0.04    // Step size while manually probing Z axis.    // custom setup BP
...
//
#define Z_SAFE_HOMING   // custom setup BP
...
//
#define EEPROM_SETTINGS // Enable for M500 and M501 commands    // custom setup BP
//#define DISABLE_M503    // Saves ~2700 bytes of PROGMEM. Disable for release!
//#define EEPROM_CHITCHAT   // Give feedback on EEPROM commands. Disable to save PROGMEM.   // custom setup BP
 ...
 */
#define NOZZLE_PARK_FEATURE   // custom setup BP
...
//
#define CR10_STOCKDISPLAY     // custom setup BP
