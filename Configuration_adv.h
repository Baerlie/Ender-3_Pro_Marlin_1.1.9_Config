...
//#define CODEPENDENT_XY_HOMING
   ...
   */
  #define BLTOUCH_SET_5V_MODE   // custom setup BP
 ...
 */
#define BABYSTEPPING    // custom setup BP (Ender-3 Pro original firmware)
#if ENABLED(BABYSTEPPING)
  //#define BABYSTEP_XY              // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false    // Change if Z babysteps should go the other way
  #define BABYSTEP_MULTIPLICATOR 40   // Babysteps are very small. Increase for faster motion.    // custom setup BP (Ender-3 Pro original firmware)
  #define BABYSTEP_ZPROBE_OFFSET   // Enable to combine M851 and Babystepping   // custom setup BP
...
// G2/G3 Arc Support
//
//#define ARC_SUPPORT               // Disable this feature to save ~3226 bytes   // custom setup BP
